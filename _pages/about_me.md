...
title: "Welcome!"
---
Since September 2025, I have started a new position as an Assistant Professor in Ecology and Statistics at Paris-Saclay University, as part of the [Ecology, Society, and Evolution](https://www.ese.universite-paris-saclay.fr/en/plant-ecophysiology/) Laboratory. 

<br>

My professional interests include \[forest, soil, coastal...\] ecology, biogeochemistry, global changes, spatial modelling, R, data analysis and reproducible coding. Previously, I spent a year (split with my maternity leave) as a Research Scholar in the [Biodiversity, Ecology, and Conservation](https://iiasa.ac.at/programs/bnr/bec) group of the International Institute of Applied Systems Analysis (IIASA) in Austria, working on the [RESIST](https://iiasa.ac.at/projects/resist) project. Before that, I spent two years in the [Global Coastal Wetlands](https://www.globalcoastalwetlands.com/) team of the [Conservation Science Group](https://www.zoo.cam.ac.uk/directory/conservation-science-group-members) at the University of Cambridge, working on a global model and map of soil carbon in tidal marshes. During my time in Cambridge, I also completed the [Postgraduate Certificate](https://www.ice.cam.ac.uk/course/postgraduate-certificate-teaching-and-learning-higher-education) in Teaching and Learning in Higher Education.


<figure class = "figure">
	<a height="400" href="/img/final_predicted_SOC_both_layers.png"><img src="/img/final_predicted_SOC_both_layers.png"></a>
</figure>
