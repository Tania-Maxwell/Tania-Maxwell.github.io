...
title: "Welcome!"
---
<img align="right" src="/img/pic_scotora_website_mini.png"> Starting in September 2025 I will be starting a new position as an Assistant Professor in Ecology and Statistics at the University Paris-Saclay, as part of the [Ecology, Society, and Evolution](https://www.ese.universite-paris-saclay.fr/en/plant-ecophysiology/) Laboratory. I am currently finishing up my position as a a Research Scholar in the [Biodiversity, Ecology, and Conservation](https://iiasa.ac.at/programs/bnr/bec) group of the International Institute of Applied Systems Analysis (IIASA) in Austria, working on the [RESIST](https://iiasa.ac.at/projects/resist) project. Previously, I spent two years in the [Global Coastal Wetlands](https://www.globalcoastalwetlands.com/) team of the [Conservation Science Group](https://www.zoo.cam.ac.uk/directory/conservation-science-group-members) at the University of Cambridge, working on a global model and map of soil carbon in tidal marshes. During my time in Cambridge, I also completed the [Postgraduate Certificate](https://www.ice.cam.ac.uk/course/postgraduate-certificate-teaching-and-learning-higher-education) in Teaching and Learning in Higher Education.
